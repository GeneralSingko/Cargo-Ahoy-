...
public partial class @UserInput : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""8d155273-18c9-474a-b4d8-f2fbdcddfa19"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
    ...
    ""controlSchemes"": [
        ...
        m_Sailing_Pause = m_Sailing.FindAction("Pause", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Sailing_Pause;
    public struct SailingActions
    {
        private @UserInput m_Wrapper;
        public SailingActions(@UserInput wrapper) { m_Wrapper = wrapper; }
        ...
        public InputAction @Pause => m_Wrapper.m_Sailing_Pause;
        ...
        public void SetCallbacks(ISailingActions instance)
        {
            if (m_Wrapper.m_SailingActionsCallbackInterface != null)
            {
                ...
                @Pause.started -= m_Wrapper.m_SailingActionsCallbackInterface.OnPause;
                @Pause.performed -= m_Wrapper.m_SailingActionsCallbackInterface.OnPause;
                @Pause.canceled -= m_Wrapper.m_SailingActionsCallbackInterface.OnPause;
            }
